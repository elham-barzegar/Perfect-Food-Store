...
export default function Home(){
    ...
    // console.log(bestSellerProductsData)
    ...
    return (
        <>
            ...
            <Section className="m-[auto]">
                ...
                {popularProductsData && <SimpleProductSlider nextEl={'.swiper-nav-right'} prevEl={'.swiper-nav-left'}
            ...
            <Section className="m-[auto]">
                ...
                {popularFruitProductsData &&
                    <SimpleProductSlider nextEl={'.swiper-nav-right2'} prevEl={'.swiper-nav-left2'}
            ...
            <Section className="m-[auto]">
                ...
                <div className="flex gap-[24px]">
                    ...
                    { bestSellerProductsData && <BestSellersSlider sliderData={bestSellerProductsData.data}/>}

                </div>
            </Section>

            <Section className="m-[auto]">
                <div className="flex justify-between items-center mb-[50px] mt-[50px]">
                    <h2 className="text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading3 text-blue-300">Deals
                        Of The Days</h2>
                    <Link className="flex items-center" href="#">All Deals<IconBox icon={"icon-angle-small-right"}
                                                                                   size={24}/></Link>
                </div>
