...
const ProductCardBottom = ({productData}: Props) => {
                ...
                currentProductInBasket ?
                    ...
                    <div className="input-product__container border-[1px] rounded-[4px] border-green-300 text-green-300 h-[30px] p-[3px] w-[80px] flex justify-between">
                        <div className="flex flex-col justify-between">
                            <IconBox icon={"up icon-angle-small-up"} onClick={()=> basket.incrementItem(productData.id)} size={10}/>
                            <IconBox icon={"down icon-angle-small-down"} onClick={()=> basket.decrementItem(productData.id)}  size={10}/>
                        </div>
                        {
